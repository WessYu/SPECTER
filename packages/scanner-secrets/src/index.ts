...
const PATTERNS: readonly SecretPattern[] = [
  ...
  },
  {
    ...
    regex:
      /\b(?:client_secret|oauth_secret|api_secret|secret_key)\s*[:=]\s*["'`]([A-Za-z0-9_./+\-=]{16,})["'`]/gi,
    severity: "high",
    confidence: "medium",
  },
];
...
const metadata: RuleMetadata = {
  ...
  remediation:
    "Revoke the exposed credential, remove it from source/history where appropriate, and load it from a secret manager or protected environment variable.",
  falsePositiveGuidance:
    "Example values, fixtures and documentation should use unmistakable placeholders and are excluded by default.",
};
